...
import { ScheduleView, ScheduleViewUser, ScheduleDelete } from ".";
...
export const ScheduleTableList = ({
  schedule,
  setSchedule,
}: IScheduleTableList) => {
  return (
    <>
      <div className="overflow-x-auto">
        <table className="table min-w-full  ">
          ...
          <tbody>
            {schedule &&
              schedule.map((item: Schedule, index: number) => (
                <tr key={`schedule${item.scheduleId}`}>
                  ...
                  <td>
                    <AdminModal
                      ...
                      label={
                        <>
                          {item.usersChedule.length.toString()}{" "}
                  ...
                  <td>
                    ...
                    >
                      <ScheduleDelete scheduleId={item.scheduleId} />
                    </AdminModal>
                  </td>
                </tr>
              ))}
